...
var mapa = new Array();
	...
	mapa[1] = "__x_r_x____x__x________x__________r______r______";
	mapa[2] = "__x___x_r__x__x________x_____r_______r__________";
	mapa[3] = "__x_r_x____x__x__r__x______xxxxxxxxxxxxxxxx_____";
	mapa[4] = "__x___x____x__x_____x_____x________r_______x____";
	mapa[5] = "___r__x________x_____r___x_____r_xxxx_______x___";
	mapa[6] = "____x_x________x__r______x_______x__x___r___x___";
	mapa[7] = "___x__x__r_____x____x____x_______xr_x_______x___";
	mapa[8] = "__x_______r________r_____x___r__xx__xx__r___x___";
	mapa[9] = "__x__r________r__________x______x____x______x___";
	mapa[10] = "___x_x_x_________________x_____xxr____xx____x___";
	mapa[11] = "_x_x_______r___x_________x_xxx_x______xxxxx_x___";
	mapa[12] = "_________r_____x_________x_x__________r___x_x___";
	mapa[13] = "__r_____xx____x__________x_x____ x__x_____x_x___";
	mapa[14] ="____xx________x_r__r_____x_xx____x__x____xx_x___";
	mapa[15] = "_x_x_______x_____________x__xx___r______xx__x___";
	mapa[16] = "___x_______x__r__________x___xx___r____xx___x___";
	mapa[17] = "__x__x__r__x_____________x___xx________xx___x___";
	mapa[18] = "__r___xxx__x_____________x___x___r______x___x___";
	mapa[19] = "_____xx__________________x__xx____xx____xx__x___";
	mapa[20] = "________r________________x__x___xxxxxx___x__x___";
	mapa[21] = "_xxxxxxxx__x_r______r____x__x__xx_r__xx_____x___";
	mapa[22] = "_xxxxxxxx___xx___________x__xxxx______xxxx__x___";
	mapa[23] = "___r________r______r______x______r___________x___";
	mapa[24] = "______r___________________x__x____r________x____";
	mapa[25] = "___r_________r_______r_____xxxxxxx__xxxxxxx_____";
	...
	var pared1 = new THREE.BoxGeometry(48, 1, 20);
	var pared2 = new THREE.BoxGeometry(1, 48, 20);
	var pared3 = new THREE.BoxGeometry(48, 1, 20);
	var pared4 = new THREE.BoxGeometry(1, 48, 20);
	pared1.translate(0,24,9);
	pared2.translate(24,0,9);
	pared3.translate(0,-24,9);
	pared4.translate(-24,0,9);
	...
	var textura2 = THREE.ImageUtils.loadTexture('http://daviduppen.github.io/PARED1.gif');
  	var material2 = new THREE.MeshBasicMaterial( {map: textura2} );
	var textura3 = THREE.ImageUtils.loadTexture('http://daviduppen.github.io/PARED2.gif');
  	var material3 = new THREE.MeshBasicMaterial( {map: textura3} );
	var textura4 = THREE.ImageUtils.loadTexture('http://daviduppen.github.io/PARED3.gif');
  	var material4 = new THREE.MeshBasicMaterial( {map: textura4} );
	var textura5 = THREE.ImageUtils.loadTexture('http://daviduppen.github.io/PARED4.gif');
